function PrivacyPolicy() {
  return (
    <div className="text-slate-500 dark:bg-slate-950 px-5 lg:px-40 py-16 flex flex-col justify-around space-y-5">
      ...
      <ul className="list-disc ml-10 space-y-3">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Desk Booking.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Desk Booking, accessible from{" "}
            <a
              href="https://desk-booking.onrender.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://desk-booking.onrender.com
            </a>
          </p>
        </li>
        <li>
      ...
      <h1 className="text-xl">Collecting and Using Your Personal Data</h1>
      ...
      <h2 className="text-lg">Use of Your Personal Data</h2>
      ...
      <h2 className="text-lg">Delete Your Personal Data</h2>
      <p>
      ...
      <h1 className="text-xl">Links to Other Websites</h1>
      <p>
      ...
      <ul className="list-disc ml-10 space-y-3">
        <li>By email: support@desk-booking.onrender.com</li>
      </ul>
    </div>
  );
}
