function TermsAndConditions() {
  return (
    <div className="text-slate-500 dark:bg-slate-950 px-5 lg:px-40 py-16 flex flex-col justify-around space-y-5">
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>

      <p>Welcome to Desk Booking!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Desk Booking's Website, located at https://desk-booking.onrender.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Desk Booking if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Desk Booking, you agreed to
        use cookies in agreement with the Desk Booking's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Desk Booking and/or its licensors own the
        intellectual property rights for all material on Desk Booking. All
        intellectual property rights are reserved. You may access this from Desk
        Booking for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul className="list-disc ml-10 space-y-3">
        <li>Republish material from Desk Booking</li>
        <li>Sell, rent or sub-license material from Desk Booking</li>
        <li>Reproduce, duplicate or copy material from Desk Booking</li>
        <li>Redistribute content from Desk Booking</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Desk
        Booking does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Desk Booking,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, Desk Booking shall not be liable
      ...
      <p>
        Desk Booking reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Desk Booking a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Desk Booking; and (d) the link
      ...
      <p>
        ...
        e-mail to Desk Booking. Please include your name, your organization
      ...
      <p>
        No use of Desk Booking's logo or other artwork will be allowed for
